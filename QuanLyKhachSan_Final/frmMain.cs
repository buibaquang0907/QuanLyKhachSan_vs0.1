...
{    
    public partial class frmMain : Form
    {
        ...
        public void loadHienTrang()
        {
            ...
            List<PHONG> listPhong = context.PHONGs.ToList();// de ktra tung phong
            List<PHONG> listPhongTrong = context.PHONGs.ToList(); // thuc hien viec xoa neu phong do dang dc thue
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            NHANVIEN nhanVien = context.NHANVIENs.FirstOrDefault(p => p.maNhanVien == taiKhoan.maNhanVien);
        ...
        {
            TAIKHOAN tk = context.TAIKHOANs.FirstOrDefault(p => p.tenDangNhap == tenDangNhap);
