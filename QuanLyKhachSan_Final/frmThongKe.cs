...
namespace QuanLyKhachSan_Final
{
    public partial class frmThongKe : Form
    {
        ...
        {
            TAIKHOAN nhanVienHienHanh = context.TAIKHOANs.FirstOrDefault(p => p.tenDangNhap == tendangnhap);
            if (rdoXuatTatCa.Checked == true)
            {
                ...
                if (listHoaDon != null)
                {
                    ...
                    {
                        PHIEUTHUEPHONG phieutemp = context.PHIEUTHUEPHONGs.FirstOrDefault(p => p.maPhieuThue == item.maPhieuThue);
                ...
                this.reportViewer1.LocalReport.ReportPath = "E:\\DoAn_Winform\\QuanLyKhachSanFinal_Git-main\\QuanLyKhachSan_Final\\QuanLyKhachSan_Final\\rptHoaDonReport.rdlc";
            ...
            {
                var listHoaDon = context.HOADONs.Where(p => p.ngayThanhToan.Value.Month == dateTimePickerThang.Value.Month && p.ngayThanhToan.Value.Year == dateTimePickerThang.Value.Year);
            ...
            {
                List<HOADON> listHoaDon = context.HOADONs.Where(p => DbFunctions.TruncateTime(p.ngayThanhToan) >= DbFunctions.TruncateTime(dateTimePickerNgay1.Value) && 
