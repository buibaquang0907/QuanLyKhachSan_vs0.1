...
namespace QuanLyKhachSan_Final
{
    public partial class frmTaiKhoan : Form
    {
        ...
        private void frmTaiKhoan_Load(object sender, EventArgs e)
        {
            ...
            List<PHANQUYEN> listQuyen = context.PHANQUYENs.ToList();
            ...
            try
            {
                if (txtTenDangNhap.Text != "" && txtMatKhau.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        context.SaveChanges();
                        listTaiKhoan = context.TAIKHOANs.ToList();
                        BrindGrid(listTaiKhoan);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                TAIKHOAN dbDelete = context.TAIKHOANs.FirstOrDefault(p => p.tenDangNhap == txtTenDangNhap.Text);
                if (dbDelete != null)
                {
                    if (txtTenDangNhap.Text != "")
                    {
                        ...
                        if (re == DialogResult.Yes)
                        {
                            ...
                            context.SaveChanges();
                            List<TAIKHOAN> listKhachHang = context.TAIKHOANs.ToList();
